...
public class CollectingResults {
	...
	public static void main(String[] args) {
        ...
        System.out.println(doubleAns);//4.0
        
		//	averagingInt(ToIntFunction f) returns a Double as well because average always returns a double
        s1 = Stream.of("3", "4", "5");
        double intAns = s1
				.collect(Collectors
							.averagingInt(//return a Double wrapper class
									num -> Integer.parseInt(num)));
        System.out.println(intAns);//4.0
		...
		System.out.println(map6);// {5=[lions, bears], 6=[tigers]} same rapresentation despite different type
