...
/**
 * Topic  : Waiting for the termination of some tasks, such as a never ending one, with a simple shutdownNow() and awaitTermination()
 ...
 *
 */
public class WaitingForNeverendingtaskToFinishWithShutDownNowAndAwaitTermination extends BaseShuttingDownUsecase{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try{
			...
			if(service != null) service.shutdownNow();//attempts to stop all executing tasks via Thread.interrupt(), block the process of waiting for the tasks
