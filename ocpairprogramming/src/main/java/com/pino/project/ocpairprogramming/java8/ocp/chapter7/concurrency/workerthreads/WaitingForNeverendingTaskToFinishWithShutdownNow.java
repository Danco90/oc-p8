...
/**
 * Topic  : Waiting for the termination of some tasks, such as a never ending one, with shutdownNow()
 ...
 *
 */
public class WaitingForNeverendingTaskToFinishWithShutdownNow extends BaseShuttingDownUsecase{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try{
			...
			shutdownNow(service);//attempts to stop all executing tasks via Thread.interrupt(), block the process of waiting for the tasks
