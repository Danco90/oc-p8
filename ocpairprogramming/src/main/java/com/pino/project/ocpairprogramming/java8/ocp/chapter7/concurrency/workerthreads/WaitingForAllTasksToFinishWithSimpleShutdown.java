...
/**
 * Usecase  : Waiting for the termination of some tasks with a simple shutdown()
 ...
 *
 */
public class WaitingForAllTasksToFinishWithSimpleShutdown extends BaseShuttingDownUsecase{
